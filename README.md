...
<p align="center">
  <a href="https://github.com/xielab2017/Agent-Hub/releases"><img alt="version" src="https://img.shields.io/badge/version-5.3.3-rose.svg" /></a>
...
确认健康检查里显示 `"version": "5.3.3"`。如果仍然不对，可临时换端口验证当前源码：
